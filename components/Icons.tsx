...
export const IconSupplyChain: React.FC<IconProps> = ({ className }) => (
...
export const IconTool: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M11.42 15.17L14.25 14.25" />
  </svg>
);
...
export const IconHighlight: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122l9.37-9.37a2.828 2.828 0 114 4l-9.37 9.37a4.5 4.5 0 01-1.897 1.13L6.93 21.485a.75.75 0 01-.912-.912l.733-2.733a4.5 4.5 0 011.13-1.897z" />
  </svg>
);

export const IconSquiggle: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
